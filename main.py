...
class ResultScreen(Screen):
    def on_enter(self, *args):
        ...
        result_label.text = f"Your score: {quiz_screen.score}/{len(quiz_screen.questions)}"

class ResultScreen2(Screen):
    def on_enter(self, *args):
        # Display the total score on the ResultScreen2
...
class ResultScreenN(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_n = self.manager.get_screen('quiz_screen_n')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_n.score}/{len(quiz_screen_n.questions)}"
...
class ResultScreenE(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_e = self.manager.get_screen('quiz_screen_e')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_e.score}/{len(quiz_screen_e.questions)}"
...
class ResultScreenV(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_v = self.manager.get_screen('quiz_screen_v')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_v.score}/{len(quiz_screen_v.questions)}"
...
class ResultScreenQ(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_q = self.manager.get_screen('quiz_screen_q')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_q.score}/{len(quiz_screen_q.questions)}"
...
class ResultScreenG0(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_g0 = self.manager.get_screen('quiz_screen_g0')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_g0.score}/{len(quiz_screen_g0.questions)}"
...
class ResultScreenG1(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_g1 = self.manager.get_screen('quiz_screen_g1')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_g1.score}/{len(quiz_screen_g1.questions)}"
...
class ResultScreenG2(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_g2 = self.manager.get_screen('quiz_screen_g2')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_g2.score}/{len(quiz_screen_g2.questions)}"
...
class ResultScreenG3(Screen):
    ...
    def on_enter(self, *args):
        # Display the total score on the ResultScreenN
        quiz_screen_g3 = self.manager.get_screen('quiz_screen_g3')
        result_label = self.ids.result_label
        result_label.text = f"Result: {quiz_screen_g3.score}/{len(quiz_screen_g3.questions)}"
